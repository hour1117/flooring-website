...
const t: Record<string, Record<string, string>> = {
  ...
  projectDesc: {
    en: 'Every project reflects a commitment to exceptional materials, refined aesthetics, and flawless execution. Trusted by partners across global markets, Liwin Flooring delivers bespoke wood flooring solutions that elevate residential, hospitality, and commercial environments.',
    ru: 'Каждый проект отражает приверженность исключительным материалам, утонченной эстетике и безупречному исполнению. Нам доверяют партнеры на мировых рынках — Liwin Flooring предлагает индивидуальные решения из дерева, которые преображают жилые, гостиничные и коммерческие пространства.',
    zh: '每个项目都体现着对卓越材料、精致美学与完美执行的承诺。Liwin Flooring 深受全球市场合作伙伴的信赖，提供量身定制的地板解决方案，提升住宅、酒店及商业空间品质。',
    es: 'Cada proyecto refleja un compromiso con materiales excepcionales, estética refinada y ejecución impecable. Con la confianza de socios en mercados globales, Liwin Flooring ofrece soluciones de pisos a medida que elevan espacios residenciales, hoteleros y comerciales.',
    fr: 'Chaque projet reflète un engagement envers des matériaux d\'exception, une esthétique raffinée et une exécution sans faille. Reconnu par des partenaires sur les marchés mondiaux, Liwin Flooring propose des solutions de parquet sur mesure qui subliment les espaces résidentiels, hôteliers et commerciaux.',
    pt: 'Cada projeto reflete um compromisso com materiais excepcionais, estética refinada e execução impecável. Reconhecido por parceiros em mercados globais, a Liwin Flooring oferece soluções de pisos sob medida que elevam espaços residenciais, hoteleiros e comerciais.',
  },
  projectBottom: {
